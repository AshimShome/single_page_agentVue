...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2022 at 12:57 PM
...
CREATE TABLE `agent_customers` (
  ...
  `customer_division` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_area` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `agent_customers` (`id`, `customer_id`, `customer_name`, `customer_email`, `customer_mobile`, `customer_division`, `customer_area`, `customer_address`, `created_at`, `updated_at`) VALUES
(14, 'wetrw', 'wettwtttyhdhydhy', 'weterydfydydeyy@gmail.com', '6564564786544', 'Khulna', 'Chandpur', 'rfwst trf wetrwe wetetwet', NULL, NULL);
...
(9, '2022_09_11_104307_create_agent_customers_table', 2);
